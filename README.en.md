...
> - Tested on **3.11.2, 3.12.3 and 3.14.0 (Windows x64)**. The script locates chunks by pattern, so nearby versions usually work too; it will tell you if the structure changed too much.
